...
/**
 * @title RhythmRushToken
 * @dev ERC20 token for RhythmRush play-to-earn game
 * Used for game rewards, payments, and in-game economy
 * Compatible with Celo network
 */
contract RhythmRushToken is ERC20, ERC20Burnable, ERC20Pausable, Ownable, ReentrancyGuard {
    ...
    constructor(
        address _treasury
    ) ERC20("RhythmRush Token", "RUSH") Ownable(msg.sender) {
