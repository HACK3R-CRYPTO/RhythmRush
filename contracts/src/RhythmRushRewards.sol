...
/**
 * @title RhythmRushRewards
 * @dev Reward distribution contract for RhythmRush play-to-earn game
 * Handles score submissions, leaderboard tracking, and reward payouts
 * Uses RhythmRushToken (RUSH) for rewards
 * Compatible with Celo network
 */
contract RhythmRushRewards is Ownable, ReentrancyGuard {
    using SafeERC20 for IERC20;

    // Reward token (RhythmRushToken - RUSH)
    RhythmRushToken public rewardToken;
    ...
    /**
     * @dev Constructor
     * @param _rewardToken Address of the RhythmRushToken (RUSH)
    ...
    constructor(
        ...
        rewardToken = RhythmRushToken(_rewardToken);
